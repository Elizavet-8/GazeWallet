...
(obj => {
    ...
    obj.animation = function (elem, prop, cb) {
        ...
        prop.anim.forEach(([style, from, to]) => {
            ...
            allAnimation.push({style: style, from: from, to: to, step: step, reverse: min === to})
        });
        const rafAnimation = () => {
...
const init = () => {
    ...
    const sizeBlockList = [[3840, 2160], [2560, 1440], [1920, 1080], [1280, 720], [854, 420], [640, 360], [426, 240]];
    const sizeVideo = () => {
    ...
    const closeVideoTubeModal = () => {
        animation(overlay, {end: [["display", "none"]], anim: [["opacity", 1, 0]], count: 20}, () => {
            overlay.textContent = ""
        });
    ...
    const openVideoTubeModal = e => {
        ...
        e.preventDefault();
        animation(overlay, {start: [["display", "block"]], anim: [["opacity", 0, 1]], count: 20});
